...
z=ones(blocknum,1);   
mu=ones(blocknum,1);  
z_pre=zeros(blocknum,1);
mu_pre=zeros(blocknum,1);
lamda2_pre=zeros(208,1);
...
%% ADMM solver
tic
sigma=ADMM_robust(max_iter,vareps,sigma,mu,alpha,eta,rho,theta,gamma,N,w,z,J,F,sigma_group,dv,blocknum);
toc
